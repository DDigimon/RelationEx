...
class SequenceLabelingModel(object):
    ...
    def __init__(self, sequence_length, nb_classes, nb_hidden=512, feature_names=None,
                 ...
                 l2_rate=0.01, rnn_unit='lstm', learning_rate=0.001, clip=None,bi_direction=None):
        """
        Args:
    ...
    def build_model(self):
        ...
        if self.rnn_unit == 'lstm':
            ...
            rnn_cell=rnn.BasicLSTMCell(self.nb_hidden,forget_bias=1)
        ...
        if self.bi_direction==True:
            ...
            rnn_outputs,_=tf.nn.dynamic_rnn(rnn_cell,input_features,initial_state=initial_state
                                            ,scope='lstm',sequence_length=self.sequence_actual_length)
